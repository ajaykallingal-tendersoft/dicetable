class AppleSignUpRequestResponse {
  final bool status;
  final String? token;
  final User? user;
  ...
  factory AppleSignUpRequestResponse.fromJson(Map<String, dynamic> json) {
    final knownKeys = {
      'status',
      'token',
      'user',
    ...
    return AppleSignUpRequestResponse(
