...
class SignUpRequest {
  ...
  FormData toFormData() {
    ...
    if (passwordConfirmation != null) formData.fields.add(MapEntry('password_confirmation', passwordConfirmation!));
    ...
    if (country != null) formData.fields.add(MapEntry('country', country!)); // ✅ match Postman key
    ...
    if (accommodations != null && accommodations!.isNotEmpty) {
      formData.fields.add(MapEntry('accommodations', accommodations!.join(',')));
    }
