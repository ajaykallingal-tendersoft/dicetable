...
SubscriptionStatusResponse subscriptionStatusResponseFromJson(String str) => SubscriptionStatusResponse.fromJson(json.decode(str));

String subscriptionStatusResponseToJson(SubscriptionStatusResponse data) => json.encode(data.toJson());
...
class SubscriptionStatusResponse {
    ...
    factory SubscriptionStatusResponse.fromJson(Map<String, dynamic> json) => SubscriptionStatusResponse(
        ...
        verificationData: json["verification_data"] == null ? null : VerificationData.fromJson(json["verification_data"]),
    );
...
class Raw {
    ...
    factory Raw.fromJson(Map<String, dynamic> json) => Raw(
        ...
        canceledStateContext: json["canceledStateContext"] == null ? null : CanceledStateContext.fromJson(json["canceledStateContext"]),
        testPurchase: json["testPurchase"] == null ? [] : List<dynamic>.from(json["testPurchase"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "testPurchase": testPurchase == null ? [] : List<dynamic>.from(testPurchase!.map((x) => x)),
...
class CanceledStateContext {
    ...
    factory CanceledStateContext.fromJson(Map<String, dynamic> json) => CanceledStateContext(
        replacementCancellation: json["replacementCancellation"] == null ? [] : List<dynamic>.from(json["replacementCancellation"]!.map((x) => x)),
    );

    Map<String, dynamic> toJson() => {
        "replacementCancellation": replacementCancellation == null ? [] : List<dynamic>.from(replacementCancellation!.map((x) => x)),
    };
}
...
class LineItem {
    ...
    factory LineItem.fromJson(Map<String, dynamic> json) => LineItem(
        ...
        autoRenewingPlan: json["autoRenewingPlan"] == null ? null : AutoRenewingPlan.fromJson(json["autoRenewingPlan"]),
        offerDetails: json["offerDetails"] == null ? null : OfferDetails.fromJson(json["offerDetails"]),
        itemReplacement: json["itemReplacement"] == null ? null : ItemReplacement.fromJson(json["itemReplacement"]),
    );
...
class AutoRenewingPlan {
    ...
    factory AutoRenewingPlan.fromJson(Map<String, dynamic> json) => AutoRenewingPlan(
        autoRenewEnabled: json["autoRenewEnabled"],
        recurringPrice: json["recurringPrice"] == null ? null : RecurringPrice.fromJson(json["recurringPrice"]),
    );
...
class ItemReplacement {
    ...
    factory ItemReplacement.fromJson(Map<String, dynamic> json) => ItemReplacement(
