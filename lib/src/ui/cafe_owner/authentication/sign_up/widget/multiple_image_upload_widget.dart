        ...
        return Container(
          ...
          child: state is SignUpImageLoadingState
            ...
            children: [
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              context.read<SignUpBloc>().add(RemoveSingleImageEvent(index));
                            },
                            child: Container(
                              decoration: BoxDecoration(
              ...
              InkWell(
                onTap: () {
                  context.read<SignUpBloc>().add(PickMultipleImagesFromGalleryEvent());
                },
                child: Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
              ...
              InkWell(
                onTap: () {
                  context.read<SignUpBloc>().add(TakeMultiplePicturesEvent());
                },
                child: Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
              ...
              if (images.isNotEmpty)
                Center(
                  child: TextButton.icon(
                    onPressed: () {
                      context.read<SignUpBloc>().add(ClearAllImagesEvent());
                    },
