...
class _CustomerProfileScreenState extends State<CustomerProfileScreen> {
  ...
  void _updateControllerText(TextEditingController controller, String? newValue) {
              ...
              child: BlocConsumer<CustomerProfileBloc, CustomerProfileState>(
                builder: (context, state) {
                  ...
                  if (state.profile.data != null) {
                    ...
                    _updateControllerText(phoneController, state.profile.data?.phone);
                    _updateControllerText(countryController, state.profile.data?.country);
                    _updateControllerText(stateController, state.profile.data?.state);
                  }
