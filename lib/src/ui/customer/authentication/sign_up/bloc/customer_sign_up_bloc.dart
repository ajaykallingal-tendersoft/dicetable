  ...
  CustomerSignUpBloc({required this.authDataProvider})
    ...
    on<NameChanged>((event, emit) {
      ...
      _formState = _formState.copyWith(
        ...
        isFormValid: _isFormValid(
          _formState.copyWith(name: event.name, nameError: nameError),
        ),
      );
      emit(_formState);
    });
    ...
    on<EmailChanged>((event, emit) {
      ...
      _formState = _formState.copyWith(
        ...
        isFormValid: _isFormValid(
          _formState.copyWith(email: event.email, emailError: emailError),
        ),
      );
      emit(_formState);
    });
    ...
    on<PhoneChanged>((event, emit) {
      ...
      _formState = _formState.copyWith(
        ...
        isFormValid: _isFormValid(
          _formState.copyWith(phone: event.phone, phoneError: phoneError),
        ),
      );
      emit(_formState);
    });
    ...
    on<RegionChanged>((event, emit) {
      ...
      _formState = _formState.copyWith(
        ...
        isFormValid: _isFormValid(
          _formState.copyWith(region: event.region, regionError: regionError),
        ),
      );
      emit(_formState);
    });
