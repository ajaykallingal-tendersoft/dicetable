    ...
    for (final purchaseDetails in event.purchaseDetailsList) {
      ...
      if (purchaseDetails.status == PurchaseStatus.purchased ||
        ...
        if (purchaseDetails.status == PurchaseStatus.restored) {
          ...
          // ✅ CRITICAL FIX: Skip status check for restored purchases
          // Restored purchases already have receipts - verify directly!
          // The status check was causing 422 errors due to empty token
          print('');
          print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          print('🔄 RESTORED PURCHASE - SKIPPING STATUS CHECK');
          print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          print('   Product ID: ${purchaseDetails.productID}');
          print('   Receipt length: ${receiptData.length} chars');
          print('   ✅ Proceeding DIRECTLY to verification');
          print('   ❌ Skipping redundant status check (prevents 422 error)');
          print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          print('');
        }
